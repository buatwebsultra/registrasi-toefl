                        ...
                        <form action="{{ route('admin.logs.index') }}" method="GET" class="row g-3 align-items-end">
                            <div class="col-md-9">
                                <label for="search" class="form-label fw-bold">
                                    <i class="fas fa-search me-1"></i>Cari Log
                                </label>
                                <div class="input-group">
                                    <input type="text" name="search" id="search"
                                        class="form-control rounded-start-pill ps-4"
                                        placeholder="Cari User, Kegiatan, atau Keterangan..." value="{{ $search ?? '' }}">
                            ...
                            <div class="col-md-3">
                                <a href="{{ route('admin.logs.index') }}"
                                    class="btn btn-outline-secondary w-100 rounded-pill px-4">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="rounded-circle p-2 me-2 {{ $log->user_type === 'admin' ? 'bg-primary bg-opacity-10 text-primary' : 'bg-success bg-opacity-10 text-success' }}"
                                                        style="width: 35px; height: 35px; display: flex; align-items: center; justify-content: center;">
                                                        <i
                                                            class="fas {{ $log->user_type === 'admin' ? 'fa-user-shield' : 'fa-user' }}"></i>
                                                    </div>
                                                    <div>
