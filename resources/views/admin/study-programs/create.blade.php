                ...
                <form action="{{ route('admin.study-programs.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="level" name="level" required>
                            ...
                            <option value="Diploma 3 (D3)" {{ old('level') == 'Diploma 3 (D3)' ? 'selected' : '' }}>Diploma 3 (D3)</option>
                            <option value="Sarjana (S1)" {{ old('level') == 'Sarjana (S1)' ? 'selected' : '' }}>Sarjana (S1)</option>
                            <option value="Magister (S2)" {{ old('level') == 'Magister (S2)' ? 'selected' : '' }}>Magister (S2)</option>
                            <option value="Doktor (S3)" {{ old('level') == 'Doktor (S3)' ? 'selected' : '' }}>Doktor (S3)</option>
                        </select>
                        @error('level')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="passing_grade" name="passing_grade" value="{{ old('passing_grade', 400) }}" min="0" max="677" required>
