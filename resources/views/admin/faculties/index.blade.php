...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-3">
                <div class="card-body">
                    <form action="{{ route('admin.faculties.index') }}" method="GET" class="row g-3">
                        <div class="col-md-10">
                        ...
                        <div class="col-md-2 d-grid gap-2 d-md-block">
                            ...
                            @if(request('search'))
                                <a href="{{ route('admin.faculties.index') }}" class="btn btn-outline-secondary">Reset</a>
                            @endif
                        </div>
                    </form>
                </div>
                                ...
                                @forelse($faculties as $faculty)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('admin.faculties.delete', $faculty->id) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger btn-sm btn-delete-confirm"
                                                    data-message="Apakah Anda yakin ingin menghapus fakultas ini?">Hapus</button>
                                            </form>
                                        </td>
                                    </tr>
                                @empty
