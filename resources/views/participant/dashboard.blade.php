...
@section('content')
            ...
            <div class="row align-items-center g-4">
                    ...
                    <div class="dashboard-photo-container">
                        @if($participant->photo_path && (\Storage::disk('private')->exists($participant->photo_path) || \Storage::disk('public')->exists($participant->photo_path)))
                            <img src="{{ route('participant.file.download', ['id' => $participant->id, 'type' => 'photo']) }}"
                                alt="{{ $participant->name }}" class="dashboard-photo shadow-sm">
                        @else
                ...
                <div class="col-md-5 d-flex justify-content-center justify-content-md-end">
                    <div class="d-flex gap-2">
                        <a href="#" id="logout-link" class="btn btn-light btn-premium text-danger">
    ...
    <ul class="nav nav-pills nav-tabs-premium" id="dashboardTabs" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="participant-detail-tab" data-bs-toggle="tab"
                data-bs-target="#participant-detail" type="button" role="tab">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="test-history-tab" data-bs-toggle="tab" data-bs-target="#test-history" type="button"
                role="tab">
    ...
    <div class="tab-content" id="dashboardTabContent">
        ...
        <div class="tab-pane fade show active" id="participant-detail" role="tabpanel"
            aria-labelledby="participant-detail-tab">
                ...
                <div class="col-lg-12">
                    <div class="card premium-card border-0">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0 fw-bold text-primary"><i class="fas fa-info-circle me-2"></i>Status & Detail
                                Registrasi</h5>
                            @php
                            ...
                            <span class="badge bg-{{ $statusClass }} px-3 py-2 rounded-pill">
                                <i
                                    class="fas {{ $participant->status === 'confirmed' ? 'fa-check-circle' : 'fa-hourglass-half' }} me-1"></i>
                                {{ $statusLabel }}
                            </span>
                        </div>
                        <div class="card-body p-4">
                            @if($participant->status === 'rejected' && $participant->rejection_message)
                                <div
                                    class="alert alert-danger border-0 bg-danger bg-opacity-10 mb-4 p-3 rounded-3 d-flex align-items-start">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6 border-end-md">
                                    <div class="mb-3">
                                        <label class="text-muted small fw-bold text-uppercase mb-1">Informasi
                                            Peserta</label>
                                    ...
                                    <div>
                                        ...
                                        <div class="p-3 bg-light rounded-3">
                                            ...
                                            <div class="d-flex justify-content-between mb-2">
                                                ...
                                                <span
                                                    class="fw-bold">{{ $participant->schedule->date->format('d M Y') }}</span>
                                            </div>
                                            <div class="d-flex justify-content-between mb-2">
                                                <span class="text-muted">Waktu</span>
                                                <span
                                                    class="fw-bold">{{ \Carbon\Carbon::parse($participant->schedule->time)->format('H:i') }}
                                                    WITA</span>
                                            </div>
                                            <div class="d-flex justify-content-between">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div
                                            class="p-4 bg-primary bg-opacity-10 rounded-4 text-center border border-primary border-opacity-25">
                                            @if($participant->isSeatConfirmed())
                                                <div class="display-4 fw-bold text-primary mb-1">{{ $participant->seat_number }}
                                                </div>
                                                <div class="small text-primary opacity-75">Silakan menempati kursi sesuai nomor
                                                    di atas</div>
                                            @else
                                                <div class="h3 fw-bold text-secondary mb-1">BELUM TERBIT</div>
                                                <div class="small text-muted text-wrap">Nomor kursi akan terbit otomatis setelah
                                                    pembayaran tervalidasi</div>
                                            @endif
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div
                                            class="p-3 bg-light rounded-3 d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                @php
                                            ...
                                            <span
                                                class="text-muted small">{{ $participant->attendance_marked_at ? $participant->attendance_marked_at->format('H:i') . ' WITA' : '-' }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            @if($participant->attendance === 'absent')
                                <div class="alert alert-danger shadow-sm rounded-4 mt-4 animate__animated animate__shakeX">
                                    <h6 class="alert-heading fw-bold mb-2 text-danger"><i
                                            class="fas fa-times-circle me-2"></i>Anda Tidak Hadir</h6>
                                    <p class="mb-0 small text-dark opacity-75">Sesuai peraturan, nilai otomatis menjadi
                                        <strong>0</strong>. Silakan mendaftar tes ulang jika diperlukan.</p>
                                </div>
                            ...
                            @if(!is_null($participant->test_score) && $participant->is_score_validated)
                                                <div class="mt-5 pt-4 border-top">
                                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                                        <h5 class="mb-0 fw-bold"><i class="fas fa-award text-warning me-2"></i>Hasil Tes Terbaru
                                                        </h5>
                                                    ...
                                                    <div class="row g-4 align-items-center">
                                                        <div class="col-md-4 text-center border-end-md">
                                                            <div class="p-4 bg-primary bg-opacity-5 rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3"
                                                                style="width: 140px; height: 140px;">
                                                                <div class="display-4 fw-bold text-dark mb-0">
                                                                    {{ number_format($participant->test_score, 0, '', '') }}</div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="row g-3">
                                                                @if(($participant->test_format ?? 'iBT') == 'PBT')
                                                                    <div class="col-4">
                                                                        <div class="p-3 bg-light rounded-3 text-center">
                                                                            <div class="h5 fw-bold text-dark mb-1">
                                                                                {{ $participant->listening_score_pbt ?: '0' }}</div>
                                                                    ...
                                                                    <div class="col-4">
                                                                        <div class="p-3 bg-light rounded-3 text-center">
                                                                            <div class="h5 fw-bold text-dark mb-1">
                                                                                {{ $participant->structure_score_pbt ?: '0' }}</div>
                                                                    ...
                                                                    <div class="col-4">
                                                                        <div class="p-3 bg-light rounded-3 text-center">
                                                                            <div class="h5 fw-bold text-dark mb-1">
                                                                                {{ $participant->reading_score_pbt ?: '0' }}</div>
                                                                ...
                                                                @else
                                                                    <div class="col-3">
                                                                        <div class="p-3 bg-light rounded-3 text-center">
                                                                            <div class="h5 fw-bold text-dark mb-1">
                                                                                {{ $participant->reading_score ?: '0' }}</div>
                                                                            <div class="small text-muted">Reading</div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-3">
                                                                        <div class="p-3 bg-light rounded-3 text-center">
                                                                            <div class="h5 fw-bold text-dark mb-1">
                                                                                {{ $participant->listening_score ?: '0' }}</div>
                                                                    ...
                                                                    <div class="col-3">
                                                                        <div class="p-3 bg-light rounded-3 text-center">
                                                                            <div class="h5 fw-bold text-dark mb-1">
                                                                                {{ $participant->speaking_score ?: '0' }}</div>
                                                                    ...
                                                                    <div class="col-3">
                                                                        <div class="p-3 bg-light rounded-3 text-center">
                                                                            <div class="h5 fw-bold text-dark mb-1">
                                                                                {{ $participant->writing_score ?: '0' }}</div>
                                                            ...
                                                            <div
                                                                class="mt-4 p-3 bg-{{ $participant->passed ? 'success' : 'warning' }} bg-opacity-10 rounded-3 border-start border-4 border-{{ $participant->passed ? 'success' : 'warning' }}">
                                                                <p class="mb-0 small text-dark">
                                                                    <strong>Catatan Kelulusan:</strong> Berdasarkan Peraturan REKTOR UHO jenjang
                                                                    {{ $participant->academic_level_display }}, ambang batas nilai Anda adalah
                                                                    <strong>
                                                                        {{ ($participant->academic_level === 'undergraduate' || $participant->academic_level === 'bachelor' || $participant->academic_level === 'sarjana' || $participant->academic_level === 's1' || stripos($participant->academic_level, 's1') !== false || stripos($participant->academic_level, 'sarjana') !== false) ? '410' :
                                    ...
                                    <div class="col-md-12">
                                        <div class="card premium-card border-0 bg-light bg-opacity-50">
                                            <div class="card-body p-4 text-center">
                                                <p class="text-muted mb-0 small"><i class="fas fa-info-circle me-1"></i>Detail
                                                    hasil di atas adalah rangking penilaian terbaru Anda. Sertifikat resmi hanya
                                                    dapat diunduh jika status Anda <strong>PASS</strong>.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex justify-content-center gap-3 mt-5 flex-wrap">
                                @if($participant->status !== 'rejected')
                                    ...
                                    @if($isFail)
                                        <div
                                            class="alert alert-warning border-0 bg-warning bg-opacity-10 w-100 text-center rounded-4 mb-4">
                                            <i class="fas fa-exclamation-triangle me-2"></i>
                                            Kartu ujian tidak lagi tersedia karena hasil tes Anda adalah <strong>FAIL</strong>.
                                            Silakan daftar tes ulang.
                                        </div>
                                    @endif
                                ...
                                @else
                                    @if($participant->passed)
                                        <a href="{{ route('participant.certificate.download', $participant->id) }}"
                                            class="btn btn-premium btn-success">
                                            <i class="fas fa-certificate me-2"></i>Unduh Sertifikat
                                        </a>
                                    @else
                                        <a href="{{ route('participant.retake.form', $participant->id) }}"
                                            class="btn btn-premium btn-warning">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex flex-column">
                                                            <span
                                                                class="fw-medium">{{ $history->test_date ? $history->test_date->format('d M Y') : ($history->schedule ? $history->schedule->date->format('d M Y') : '-') }}</span>
                                                            <span
                                                                class="small text-muted">{{ $history->test_date ? $history->test_date->format('H:i') : ($history->schedule ? \Carbon\Carbon::parse($history->schedule->time)->format('H:i') : '') }}
                                                                WITA</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        ...
                                                        @if($history->test_score && $history->is_score_validated)
                                                            <div class="d-inline-block text-center">
                                                                <div class="h5 mb-0 fw-bold text-dark">
                                                                    {{ number_format($history->test_score, 0, '', '') }}</div>
                                                                <span
                                                                    class="badge bg-{{ $history->passed ? 'success' : 'warning' }} bg-opacity-10 text-{{ $history->passed ? 'success' : 'warning' }} rounded-pill small px-2">
                                                                    {{ $history->passed ? 'PASS' : 'FAIL' }}
                                                                </span>
                                                            </div>
                                                        @else
                                                            <span class="badge bg-secondary bg-opacity-10 text-secondary">Belum
                                                                Dinilai</span>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if(($history->test_format ?? 'iBT') == 'PBT' && $history->is_score_validated)
                                                            <div class="d-flex gap-2">
                                                                <span class="badge bg-light text-muted border" title="Listening">L:
                                                                    {{ $history->listening_score_pbt ?: '-' }}</span>
                                                                <span class="badge bg-light text-muted border" title="Structure">S:
                                                                    {{ $history->structure_score_pbt ?: '-' }}</span>
                                                                <span class="badge bg-light text-muted border" title="Reading">R:
                                                                    {{ $history->reading_score_pbt ?: '-' }}</span>
                                                            </div>
                                                        @else
                                                            <div class="d-flex flex-wrap gap-2">
                                                                <span class="badge bg-light text-muted border" title="Reading">R:
                                                                    {{ $history->reading_score ?: '-' }}</span>
                                                                <span class="badge bg-light text-muted border" title="Listening">L:
                                                                    {{ $history->listening_score ?: '-' }}</span>
                                                                <span class="badge bg-light text-muted border" title="Speaking">S:
                                                                    {{ $history->speaking_score ?: '-' }}</span>
                                                                <span class="badge bg-light text-muted border" title="Writing">W:
                                                                    {{ $history->writing_score ?: '-' }}</span>
                                                            </div>
                                                        @endif
                                                    </td>
                                                    <td class="pe-4 text-end">
                                                        <span
                                                            class="text-muted small">{{ $history->created_at->format('d M Y') }}</span>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                    ...
                    @else
                        <div class="card premium-card border-0 shadow-sm">
                            <div class="card-body p-5 text-center">
                                ...
                                <p class="text-muted">Data riwayat tes Anda akan muncul di sini setelah Anda mengikuti ujian.
                                </p>
                            </div>
                        </div>
                    @endif
                                    ...
                                    <div class="p-3 border rounded-3 text-center h-100 bg-light bg-opacity-50">
                                        ...
                                        <div class="d-flex gap-2 justify-content-center mb-2">
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-warning"
                                                data-bs-toggle="modal" data-bs-target="#updatePaymentProofModal">
                                ...
                                <div class="col-md-4">
                                    <div class="p-3 border rounded-3 text-center h-100 bg-light bg-opacity-50">
                                        ...
                                        <div class="d-flex gap-2 justify-content-center mb-2">
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-warning"
                                                data-bs-toggle="modal" data-bs-target="#updateKtpModal">
                                                <i class="fas fa-upload me-1"></i>Ganti
                                            </button>
                                        </div>
                                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <div class="modal-body p-0 text-center bg-light">
                <img src="{{ route('participant.file.download', ['id' => $participant->id, 'type' => 'photo']) }}"
                    alt="Foto Peserta Full" class="img-fluid" style="max-height: 80vh;">
            </div>
...
<div class="modal fade" id="updatePaymentProofModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('participant.document.update', $participant->id) }}" method="POST"
