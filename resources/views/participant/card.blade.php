...
<body>
    <div class="card">
        <div class="watermark-logo">
            <img src="{{ asset('logo-uho-diktisaintek-text-biru.png') }}" alt="Logo UHO" />
        </div>
        ...
        <div class="content-wrapper">
            <div class="photo-section">
                <div class="photo-container">
                    <img src="{{ asset('storage/' . $participant->photo_path) }}" alt="Pas Photo Peserta"
        ...
        <div class="participant-info">
            ...
            <div class="info-row">
                ...
                <div class="info-value">{{ $participant->schedule->used_capacity }} dari
