    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('participant.retake.process', $participant->id) }}" method="POST"
                                    ...
                                    <select class="form-select" id="schedule_id" name="schedule_id" required>
                                        ...
                                        @foreach($schedules as $schedule)
                                            <option value="{{ $schedule->id }}">
                                                {{ $schedule->date->format('d M Y') }} - Ruangan: {{ $schedule->room }}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">Masukkan Tanggal, Jam, Menit, dan Detik persis seperti yang
                                        tertera pada struk/bukti transfer Anda.</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control @error('payment_proof') is-invalid @enderror"
                                        id="payment_proof" name="payment_proof" accept="image/jpeg,image/jpg,image/png"
                                        required>
                                    @error('payment_proof')
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('participant.dashboard', $participant->id) }}"
                                class="btn btn-secondary me-md-2">Batal</a>
                            <button type="submit" class="btn btn-primary btn-lg" id="submitBtn">Kirim Pendaftaran
                                Ulang</button>
                        </div>
                    </form>
                </div>
            ...
            form.addEventListener('submit', function (e) {
                ...
                if (paymentProof.files.length > 0) {
                    ...
                    if (fileSize > 1) {
                        ...
                        const errorDiv = document.createElement('div');
                        errorDiv.className = 'invalid-feedback';
                        errorDiv.textContent = 'Ukuran file bukti pembayaran melebihi kapasitas maksimal (1MB).';
